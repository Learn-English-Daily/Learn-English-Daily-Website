...
export const metadata: Metadata = {
  title: "Vocabulary Match | LEAD Games",
  description: "Match English words with meanings and example sentences in a timed vocabulary game."
};

export const dynamic = "force-dynamic";

export default async function VocabularyMatchPage() {
  noStore();
  ...
  if (!isGamesPasswordConfigured() || !isAuthenticated) {
    return <GamesPasswordGate redirectTo="/games/vocabulary-match" title="Vocabulary Match" />;
  }

  return (
    <main className="min-h-screen bg-lead-soft">
      <section className="relative overflow-hidden bg-[linear-gradient(135deg,#eff6ff_0%,#ffffff_48%,#ecfdf5_100%)] py-10">
        ...
        <div className="container-shell relative z-10">
          ...
          <p className="mt-6 inline-flex items-center gap-2 rounded-lg border border-emerald-100 bg-white px-4 py-2 text-sm font-bold text-emerald-700 shadow-soft">
          ...
          <p className="mt-4 max-w-2xl text-lg leading-8 text-lead-gray">
            Match words with meanings, build vocabulary confidence, and review real example sentences.
          </p>
        </div>
      </section>
