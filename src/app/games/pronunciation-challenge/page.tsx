...
export const metadata: Metadata = {
  title: "Pronunciation Challenge | LEAD Games",
  description: "Practice English pronunciation with listen-and-repeat speaking challenges."
};

export const dynamic = "force-dynamic";

export default async function PronunciationChallengePage() {
  noStore();
  ...
  if (!isGamesPasswordConfigured() || !isAuthenticated) {
    return <GamesPasswordGate redirectTo="/games/pronunciation-challenge" title="Pronunciation Challenge" />;
  }
      ...
      <section className="relative overflow-hidden bg-[linear-gradient(135deg,#eff6ff_0%,#ffffff_48%,#fff7d6_100%)] py-10">
        ...
        <div className="container-shell relative z-10">
          ...
          <p className="mt-4 max-w-2xl text-lg leading-8 text-lead-gray">
            Listen to each phrase, repeat it clearly, and improve tricky English sounds.
          </p>
        </div>
      </section>
