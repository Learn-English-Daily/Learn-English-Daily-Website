...
type AdminPageKey = "dashboard" | "inquiries" | "sessions" | "attendance" | "payments" | "students" | "batches" | "reviews";
...
const adminNavItems: Array<{
  ...
  { key: "batches", label: "Batches", href: "/admin/batches", helper: "Assessments", icon: ClipboardCheck },
